// FIPS state code -> { usps, name }. Matches the `id` field on us-atlas
// states-10m geometries (2-char zero-padded FIPS strings). Territories
// (60/66/69/72/78) are intentionally omitted — geoAlbersUsa can't project them.
export const FIPS = {
...
export const uspsFromFips = (id) => FIPS[String(id).padStart(2, "0")]?.usps;
export const nameFromFips = (id) => FIPS[String(id).padStart(2, "0")]?.name;
